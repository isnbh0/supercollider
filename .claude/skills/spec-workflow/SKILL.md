...
touch workspace/specs/${TIMESTAMP}-descriptive-name.md
```

**File naming**: `{YYMMDD-HHMMSS}-{kebab-case-description}.md`
**Location**: `workspace/specs/` directory
...
git add workspace/specs/${TIMESTAMP}-descriptive-name.md
...
- [ ] File in `workspace/specs/` directory
...
ls workspace/specs/*.md

# Read it completely
cat workspace/specs/{timestamp}-name.md
```
...
5. **Archive spec to workspace/specs/archive/implemented/**
...
- Archive spec to workspace/specs/archive/implemented/
...
```bash
git mv workspace/specs/{spec}.md workspace/specs/active/{spec}.md
git add workspace/specs/active/{spec}.md
```
...
mkdir -p workspace/specs/archive/implemented
git mv workspace/specs/active/{spec}.md workspace/specs/archive/implemented/{spec}.md
git add workspace/specs/archive/implemented/{spec}.md
# OR if not in active/
git mv workspace/specs/{spec}.md workspace/specs/archive/implemented/{spec}.md
git add workspace/specs/archive/implemented/{spec}.md
```
...
git add workspace/specs/archive/implemented/{spec}.md  # or wherever spec is
...
- [ ] Spec archived to `workspace/specs/archive/implemented/`
...
### I'm WRITING a spec:
1. Create timestamped file in `workspace/specs/`
2. Investigate thoroughly
3. Write complete spec with "Status: Requires Implementation"
4. `git add workspace/specs/{spec}.md && git commit`
...
7. Archive spec to `workspace/specs/archive/implemented/`
